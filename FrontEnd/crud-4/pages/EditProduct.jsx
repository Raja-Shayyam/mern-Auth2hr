...
export const EditProduct = () => {
  ...
  const [ is1245, seTis1245 ] = useState()
  ...
  //         {/* left side */}
  //         <motion.div className=" col-md-12 col-lg-6 mb-5 text-white aos-init aos-animate" data-aos="fade-in" data-aos-delay="0" data-aos-offset="0"
    ...
    <div className="section bg-theme-color-light overlay-dark overlay-opacity-8 bg-cover p-2 lazy" data-loaded="true"
      ...
      <div className="container">
        <div className="row align-items-center justify-content-between">
          {/* left side */}
          <motion.div className="col-12 col-lg-6 mb-5 text-white text-center text-lg-start aos-init aos-animate" data-aos="fade-in" data-aos-delay="0" data-aos-offset="0"
            initial={{ opacity: 0, x: 40 }}
            animate={{ opacity: 1, y: 0, x: is1245, backgroundColor: "#3603035a", boxShadow: "rgb(205 164 164 / 30%) -2px 5px 0px 3px" }}
            transition={{ duration: 0.6 }}
          // transition={{duration: 0.6 , type: "spring", stiffness: 200, damping: 20 }}
          >
            {/* main title */}
            <h1 className="display-4 fw-bold mb-0">
              <span className="d-inline-block mt-3 mb-1">
                ...
                <span className="text-danger bg-dark bg-gradient p-1">Bootdey</span> Real Estate
              </span>
            </h1>
            {/* slogan */}
            <p className="h3 fw-normal mb-0">
          ...
          <motion.div className="col-12 col-lg-6 d-flex justify-content-center justify-content-lg-end aos-init aos-animate" data-aos="fade-in" data-aos-delay="50" data-aos-offset="0"
            initial={{ opacity: 0, x: -360 }}
            // animate={{ opacity: 1, y: 0, x: -570 }}
            animate={{ opacity: 1, y: 0, x: is1245 }}
            transition={{ duration: 0.6 }}
          >
            <div className="d-inline-block  shadow-primary-xs rounded-3 p-4 p-md-5 w-100 max-w-450 text-align-start" style={{
              backgroundColor: " #f0f8ff2b",
